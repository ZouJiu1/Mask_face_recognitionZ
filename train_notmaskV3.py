...
model_path = r'/media/Mask_face_recognitionZ/Model_training_checkpoints/model_34_triplet_epoch_9_rocNMD0.855_rocMasked0.645notmaskV3.pt'
...
for epoch in range(start_epoch, end_epoch):
    ...
    if save:
        ...
        #
        torch.save(state, 'Model_training_checkpoints/model_{}_triplet_epoch_{}_rocNMD{:.3f}_rocMasked{:.3f}notmaskV3.pt'.format(config['model'],
                                                                                                     epoch + 1,
